...
int main()
{
    ...
    //ULTIMATE MOVES FOR TESTING N-CONSECUTIVES
    // game->execute_move("P 0 0");
    // game->execute_move("P 4 0");
    // game->execute_move("P 3 1");
    // game->execute_move("P 5 18");
    // game->execute_move("P 3 6");
    // game->execute_move("P 3 0");
    // game->execute_move("P 5 13");
    // game->execute_move("P 3 12");
    // game->execute_move("P 3 17");
    // game->execute_move("P 4 14");
    // game->execute_move("S 5 13 M 3 11");
    // game->execute_move("S 3 12 M 1 4");
    // game->execute_move("S 3 17 M 3 16");
    // game->execute_move("S 4 0 M 4 2");
    // game->execute_move("S 3 6 M 3 3");
    // game->execute_move("S 1 4 M 5 24");
    // game->execute_move("S 0 0 M 1 0");
    // game->execute_move("S 4 2 M 4 10");
    // game->execute_move("S 1 0 M 1 3");
    // game->execute_move("S 4 14 M 2 6");
    // game->execute_move("S 3 3 M 1 1");
    // game->execute_move("S 4 10 M 3 8");
    // game->execute_move("S 3 11 M 3 10");
    // game->execute_move("S 2 6 M 4 6");
    // game->execute_move("S 3 1 M 4 5");
    // game->execute_move("S 4 6 M 3 5");
    // game->execute_move("S 1 1 M 2 3");
    // game->execute_move("S 3 8 M 5 17");
    // game->execute_move("S 3 10 M 1 5");
    // game->execute_move("S 5 18 M 2 5");
    // game->execute_move("S 1 3 M 3 9");
    // game->execute_move("S 5 17 M 2 8");
    // game->execute_move("S 3 9 M 4 17");
    // game->execute_move("S 2 8 M 2 2");
    // game->execute_move("S 4 17 M 4 18 RS 3 9 RE 4 17 X 4 18");
    // game->execute_move("S 5 24 M 2 9");
    // game->execute_move("S 1 5 M 2 1");
    // game->execute_move("S 2 9 M 5 21");
    // game->execute_move("S 2 1 M 2 0");
    // game->execute_move("S 5 21 M 5 22");
    // game->execute_move("S 3 16 M 3 15");
    // game->execute_move("S 2 5 M 4 11");
    // game->execute_move("S 2 0 M 4 22");
    // game->execute_move("S 3 5 M 4 9");
    // game->execute_move("S 3 15 M 3 14");
    // game->execute_move("S 2 2 M 4 4");
    // game->execute_move("S 3 14 M 4 18");
    // game->execute_move("S 4 11 M 1 2");
    // game->execute_move("S 4 18 M 2 7");
    // game->execute_move("S 3 0 M 5 28");
    // game->execute_move("S 2 7 M 5 12 RS 4 10 RE 2 8 X 4 5");
    // game->execute_move("S 5 22 M 2 10");
    // game->execute_move("S 5 12 M 3 13");
    // game->execute_move("S 4 4 M 4 5");
    // game->execute_move("S 4 22 M 4 23");
    // game->execute_move("S 1 2 M 2 7");
    // game->execute_move("S 2 3 M 2 4");
    // game->execute_move("S 2 7 M 2 8");
    // game->execute_move("S 2 4 M 3 7");
    // game->execute_move("S 4 5 M 3 2");
    // game->execute_move("S 3 7 M 4 7");
    // game->execute_move("S 2 8 M 2 6");
    // game->execute_move("S 4 7 M 4 8");
    // game->execute_move("S 3 2 M 5 7");
    // game->execute_move( "S 4 23 M 2 11");
    // game->execute_move("S 2 10 M 3 11");
    // game->execute_move("S 3 13 M 4 3");
    // game->execute_move("S 4 9 M 3 4");
    // game->execute_move("S 2 11 M 4 21");
    // game->execute_move("S 2 6 M 3 9");
    // game->execute_move("S 4 21 M 3 12");
    // game->execute_move("S 3 9 M 4 12");
    // game->execute_move("S 4 3 M 4 1");
    // game->execute_move("S 3 11 M 4 15");
    // game->execute_move("S 4 8 M 4 10");
    // game->execute_move("S 5 28 M 5 27");
    // game->execute_move("S 3 12 M 4 16");
    // game->execute_move("S 5 27 M 5 29");
    // game->execute_move("S 4 16 M 4 17");
    // game->execute_move("S 4 15 M 4 13");
    // game->execute_move("S 4 17 M 3 10");
    // game->execute_move("S 5 7 M 5 9");
    // game->execute_move("S 4 10 M 5 2");
    // game->execute_move("S 3 4 M 5 19");
    // game->execute_move("S 5 2 M 5 4");
    // game->execute_move("S 5 9 M 5 6");
    // game->execute_move("S 5 4 M 5 11");
    // game->execute_move("S 4 12 M 5 14");
    // game->execute_move("S 5 11 M 4 19");
    // game->execute_move("S 4 13 M 5 16");
    // game->execute_move("S 4 19 M 4 20");
    // game->execute_move("S 5 29 M 5 26");
    // game->execute_move("S 4 1 M 5 1");
    // game->execute_move("S 5 6 M 5 8");
    // game->execute_move("S 5 1 M 5 3");
